const mySelf = {
    ...
    paragraphs: [
        `
        Hello! My name is Vivek Devkar, I like creating new things for internet. From a younger age, I have been interested in programming, as a kid most of my time I've spent in inspect element playing with colors and codes generating loops for sending infinite messages, cracking locked screen overflows and many more. so finally at the age of 16 I decided to convert this passion into career.`,
        `
        It is a way to become more crafty with my ideas and explore the endless possibilities in the world of programming.`,
        `
        Besides programming, I'm a passionate movie enthusiast and traveler. I love exploring new places and experiencing different cultures, which fuels my curiosity and broadens my perspective on the world.`,
        `
